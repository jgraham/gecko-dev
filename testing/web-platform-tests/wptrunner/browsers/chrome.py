...
from ..browser import get_free_port, Browser
from ..executor import TestExecutor, testharness_result_converter
...
class WebdriverTestExecutor(TestExecutor):
    ...
    def after_connect(self):
        ...
        self.webdriver.get(urlparse.urljoin(self.http_server_url, "/gecko_runner.html"))
    ...
    def run_test(self, test):
        ...
        except (socket.timeout, exceptions.ErrorInResponseException) as e:
...
class WebdriverTestharnessExecutor(WebdriverTestExecutor):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.script = open(os.path.join(here, "testharness_chrome.js")).read()
